...
lumbar_to_world_cam = np.matmul(lumbar_marker_to_world_cam, lumbar_to_marker)
...
tooltip_to_world_cam = np.matmul(tooltip_marker_to_world_cam, tooltip_to_marker)
